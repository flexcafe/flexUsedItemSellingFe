...
const DICT: Dictionary = {
  ...
  kbzPayRequestIntro: {
    ...
    en: "Request KBZPay verification from an admin.",
  },
  requestVerification: {
    ko: "인증 요청",
  ...
  kbzPayRequested: {
    ...
    zh: "K-pay 验证已请求",
    en: "K-pay verification requested",
  },
  kbzPayPendingHint: {
    ...
    en: "Transfer the amount below, then submit your transaction ID.",
  },
  ...
  kbzPayWaitInstructionHint: {
    ...
    zh: "请等待管理员的转账指引。",
    en: "Waiting for admin transfer instructions.",
  },
  kbzPayAmountLabel: {
    ko: "송금 금액",
    my: "လွှဲမည့် ပမာဏ",
  ...
  facebookLinkIntro: {
    ...
    en: "Link your Facebook account with a verified access token and profile URL.",
  },
  facebookOAuthButton: {
  ...
  facebookMissingAppId: {
    ...
    en: "Set EXPO_PUBLIC_FACEBOOK_APP_ID before using Facebook OAuth.",
  },
  facebookMissingPageUrl: {
    ...
    en: "Set EXPO_PUBLIC_FACEBOOK_PAGE_URL first.",
  },
  ...
  facebookFollowIntro: {
    ...
    en: "Submit a screenshot proving you follow our page.",
  },
  ...
  productsComposerStepHint1: {
    ...
    en: "Enter category, title, description, price, and condition.",
  },
  productsComposerStepHint2: {
    ko: "결제 수단과 배송 옵션을 선택하세요.",
    my: "ငွေပေးချေမှု နည်းလမ်းနှင့် ပို့ဆောင်မှု ရွေးချယ်ပါ။",
    zh: "请选择支付方式和配送选项。",
    en: "Choose payment methods and delivery options.",
  },
  productsComposerStepHint3: {
    ...
    en: "Enter meeting place, map, and extra notes.",
  },
  productsComposerStepHint4: {
    ...
    en: "Enter preferred places and image URLs, then save.",
  },
