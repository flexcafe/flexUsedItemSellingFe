...
By tapping Agree / Accept, you confirm that you have read and agree to these Terms, including the zero-tolerance policy for objectionable content and abusive users.`,
  ...
  userBlockTitle: {
    ko: "사용자 차단",
    my: "အသုံးပြုသူ ပိတ်ရန်",
    zh: "屏蔽用户",
    en: "Block user",
  },
  userBlockSubtitle: {
    ko: "차단하면 피드와 채팅에서 바로 제외됩니다.",
    my: "ပိတ်လိုက်ပါက အစာစားစာရင်းနှင့် ချတ်မှ ချက်ချင်း ဖယ်ရှားမည်။",
    zh: "屏蔽后会立即从动态和聊天中排除。",
    en: "Blocking removes them from your feed and chat right away.",
  },
  userBlockReasonLabel: {
    ko: "사유 (선택)",
    my: "အကြောင်းရင်း (ရွေးချယ်နိုင်)",
    zh: "原因（可选）",
    en: "Reason (optional)",
  },
  userBlockReasonHint: {
    ko: "운영팀이 확인할 수 있도록 간단히 적어 주세요.",
    my: "အဖွဲ့စစ်ဆေးနိုင်ရန် အတိုချုံး ရေးပါ။",
    zh: "请简要说明，便于团队核查。",
    en: "A short note helps our team review.",
  },
  userBlockReasonPlaceholder: {
    ko: "예: 채팅에서 괴롭힘",
    my: "ဥပမာ - ချတ်တွင် နှောင့်ယှက်မှု",
    zh: "例如：聊天骚扰",
    en: "e.g. Harassment in chat",
  },
  userBlockConfirm: {
    ko: "차단하기",
    my: "ပိတ်မည်",
  ...
  userBlockSuccessTitle: {
    ko: "차단 완료",
    my: "ပိတ်ပြီးပါပြီ",
    zh: "已屏蔽",
    en: "User blocked",
  },
  userBlockSuccessBody: {
    ko: "해당 사용자의 콘텐츠가 피드에서 숨겨집니다.",
    my: "ဤအသုံးပြုသူ၏ အကြောင်းအရာကို အစာစားစာရင်းမှ ဖုံးကွယ်မည်။",
    zh: "该用户的内容将从动态中隐藏。",
    en: "Their content is now hidden from your feed.",
  },
  userBlockFailed: {
    ko: "차단에 실패했습니다. 다시 시도하세요.",
    my: "ပိတ်ရန် မအောင်မြင်ပါ။ ထပ်မံကြိုးစားပါ။",
    zh: "屏蔽失败，请重试。",
    en: "Could not block this user. Please try again.",
  },
  userBlockCannotSelf: {
    ko: "자기 자신은 차단할 수 없습니다.",
    my: "မိမိကိုယ်ကို ပိတ်၍ မရပါ။",
    zh: "无法屏蔽自己。",
    en: "You cannot block yourself.",
  },
  userBlockLoginRequiredTitle: {
    ko: "로그인 필요",
    my: "လော့ဂ်အင် လိုအပ်သည်",
    zh: "需要登录",
    en: "Sign in required",
  },
  userBlockLoginRequiredBody: {
    ko: "사용자를 차단하려면 먼저 로그인하세요.",
    my: "အသုံးပြုသူ ပိတ်ရန် အရင် လော့ဂ်အင်ဝင်ပါ။",
    zh: "请先登录后再屏蔽用户。",
    en: "Please sign in to block a user.",
  },
  userBlockAction: {
    ko: "차단",
    my: "ပိတ်ရန်",
  ...
  userBlocksTitle: {
    ko: "차단한 사용자",
    my: "ပိတ်ထားသော အသုံးပြုသူများ",
    zh: "已屏蔽用户",
    en: "Blocked users",
  },
  userBlocksSubtitle: {
    ko: "차단을 해제하면 다시 피드와 채팅에 나타날 수 있습니다.",
    my: "ပိတ်မှု ဖယ်ရှားပါက အစာစားစာရင်းနှင့် ချတ်တွင် ပြန်ပေါ်နိုင်သည်။",
    zh: "取消屏蔽后，对方可能重新出现在动态和聊天中。",
    en: "Unblocking lets them appear in feed and chat again.",
  },
  userBlocksClose: {
    ko: "닫기",
    my: "ပိတ်ရန်",
  ...
  userBlocksEmptyTitle: {
    ko: "차단한 사용자가 없습니다",
    my: "ပိတ်ထားသူ မရှိသေးပါ",
    zh: "暂无已屏蔽用户",
    en: "No blocked users yet",
  },
  userBlocksEmptyBody: {
    ko: "프로필이나 채팅에서 사용자를 차단할 수 있습니다.",
    my: "ပရိုဖိုင် သို့မဟုတ် ချတ်မှ အသုံးပြုသူကို ပိတ်နိုင်သည်။",
    zh: "可在个人资料或聊天中屏蔽用户。",
    en: "You can block someone from their profile or chat.",
  },
  userBlockUnblock: {
    ko: "차단 해제",
    my: "ပိတ်မှု ဖယ်",
  ...
  userBlockUnblockTitle: {
    ko: "차단 해제",
    my: "ပိတ်မှု ဖယ်ရှားရန်",
    zh: "取消屏蔽",
    en: "Unblock user",
  },
  userBlockUnblockConfirm: {
    ko: "{name} 님의 차단을 해제할까요?",
    my: "{name} ကို ပိတ်မှု ဖယ်မလား။",
    zh: "确定取消屏蔽 {name} 吗？",
    en: "Unblock {name}?",
  },
  userBlockUnblockSuccessTitle: {
    ko: "차단 해제됨",
    my: "ပိတ်မှု ဖယ်ပြီး",
    zh: "已取消屏蔽",
    en: "User unblocked",
  },
  userBlockUnblockSuccessBody: {
    ko: "이제 피드와 채팅에 다시 나타날 수 있습니다.",
    my: "ယခု အစာစားစာရင်းနှင့် ချတ်တွင် ပြန်ပေါ်နိုင်သည်။",
    zh: "对方可能重新出现在动态和聊天中。",
    en: "They may appear in feed and chat again.",
  },
  userBlockUnblockFailed: {
    ko: "차단 해제에 실패했습니다.",
    my: "ပိတ်မှု ဖယ်ရန် မအောင်မြင်ပါ။",
    zh: "取消屏蔽失败。",
    en: "Could not unblock this user.",
  },
  userBlocksOpenButton: {
    ko: "차단 목록",
    my: "ပိတ်စာရင်း",
    zh: "屏蔽列表",
    en: "Blocked users",
  },
  chatBlockedContactTitle: {
    ko: "차단된 사용자",
    my: "ပိတ်ထားသော အသုံးပြုသူ",
    zh: "已屏蔽的用户",
    en: "Blocked contact",
  },
  chatBlockedContactBody: {
    ko: "상대방과 채팅할 수 없습니다. 한쪽이 다른 쪽을 차단했을 수 있습니다.",
    my: "ဤအသုံးပြုသူနှင့် ချတ်မရပါ။ တစ်ဖက်ဖက်က ပိတ်ထားနိုင်သည်။",
    zh: "无法与对方聊天。可能有一方屏蔽了另一方。",
    en: "You can't chat with this user. One of you may have blocked the other.",
  },
  ...
  deleteAccountTitle: {
    ko: "계정 영구 삭제",
    my: "အကောင့် အပြီးဖျက်ရန်",
    zh: "永久删除账户",
    en: "Delete account permanently",
  },
  deleteAccountSubtitle: {
    ko: "이 작업은 되돌릴 수 없습니다.",
    my: "ဤလုပ်ဆောင်ချက်ကို ပြန်မရနိုင်ပါ။",
    zh: "此操作无法撤销。",
    en: "This action cannot be undone.",
  },
  deleteAccountWarning: {
    ko: "계정이 영구적으로 삭제됩니다. 일시 비활성화가 아닙니다. 개인정보가 익명화되고 로그인이 즉시 종료됩니다.",
    my: "အကောင့်ကို အပြီးဖျက်မည်။ ယာယီ ပိတ်ခြင်း မဟုတ်ပါ။ ကိုယ်ရေးအချက်အလက်ကို အမည်ဖုံးပြီး လော့ဂ်အင် ချက်ချင်း ပိတ်မည်။",
    zh: "账户将被永久删除，不是临时停用。个人信息将匿名化，并立即退出登录。",
    en: "Your account will be permanently deleted — not deactivated. Personal data is anonymized and you are signed out immediately.",
  },
  deleteAccountNotDeactivate: {
    ko: "비활성화/정지와 다릅니다. 동일 전화번호·이메일로 다시 가입할 수 있습니다.",
    my: "ယာယီ ပိတ်ခြင်း/ပိတ်ပင်ခြင်း မဟုတ်ပါ။ တူညီသော ဖုန်း/အီးမေးလ်ဖြင့် ပြန်စာရင်းသွင်းနိုင်သည်။",
    zh: "这不是停用或封禁。之后可用同一手机号/邮箱重新注册。",
    en: "This is not a deactivate or ban. You can re-register later with the same phone or email.",
  },
  ...
  deleteAccountPasswordPlaceholder: {
    ko: "비밀번호 입력",
    my: "စကားဝှက် ထည့်ပါ",
    zh: "输入密码",
  ...
  deleteAccountConfirmHint: {
    ko: "계속하려면 DELETE 를 정확히 입력하세요.",
    my: "ဆက်လုပ်ရန် DELETE ကို တိတိကျကျ ရိုက်ပါ။",
    zh: "请准确输入 DELETE 以继续。",
    en: "Type DELETE exactly to continue.",
  },
  deleteAccountConfirmMismatch: {
    ko: "확인 문구는 정확히 DELETE 여야 합니다.",
    my: "အတည်ပြု စာသားသည် DELETE သာ ဖြစ်ရမည်။",
    zh: "确认文字必须恰好为 DELETE。",
    en: 'Confirmation must be exactly "DELETE".',
  },
  ...
  deleteAccountSuccessBody: {
    ko: "계정이 영구적으로 삭제되었습니다.",
    my: "အကောင့်ကို အပြီးဖျက်ပြီးပါပြီ။",
    zh: "您的账户已永久删除。",
    en: "Your account has been permanently deleted.",
  },
  deleteAccountFailed: {
    ko: "계정 삭제에 실패했습니다. 비밀번호를 확인하고 다시 시도하세요.",
    my: "အကောင့် ဖျက်ရန် မအောင်မြင်ပါ။ စကားဝှက် စစ်ပြီး ထပ်ကြိုးစားပါ။",
    zh: "删除账户失败。请检查密码后重试。",
    en: "Could not delete your account. Check your password and try again.",
  },
  appVersionDisplay: {
